...
class FactureController extends Controller
{
    ...
    public function printFactureReabo($id)
    {
        ...
        $data_pdf = new Array_();
        if ($reabonnement[0]->date_reabonnment != $decos[0]->date_abonnement && $decodeur[0]->prix_decoder == 0){
        ...
        $data_pdf->num_abonne = $client->num_abonne;
        ...
        $data_pdf->date_reabonnement = $decos[0]->date_reabonnement;
