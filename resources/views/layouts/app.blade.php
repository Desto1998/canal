...
<head>
    ...
    <title>{{ config('app.name', 'Canal') }}</title>
    <!-- Fonts -->
        ...
        <main>
            ...
            <!-- Sidebar -->
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <!-- Tables Buttons -->
                    <li class="nav-item">
                        <a class="nav-link {{ ($route=='view.abonner')?'active':'' }}"
                           href="{{ route('view.abonner') }}">
                            <i class="fas fa-fw fa-user-friends"></i>
                            <span>Abonnement</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ ($route=='reabonner')?'active':'' }}"
                           href="{{ route('review.reabonner') }}">
                        ...
                        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <a class="nav-link" target="_blank" href="{{ route('canal.doc') }}" role="button">
                                        <span class="mr-2 d-none d-lg-inline text-gray-600 small">Aide<i
