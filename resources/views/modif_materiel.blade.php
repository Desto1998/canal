        ...
        <center>
            <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
                <div class="card-header py-3">
                    <h4 class="m-2 font-weight-bold text-primary">Modifier prix materiel</h4>
                ...
                <div class="card-body">
                    ...
                    <form role="form" method="post" action="##">
                      ...
                      <div class="form-group">
                        Nouveau prix<br><input class="form-control" placeholder="{{ $donnees->prix }}" name="prix" required>
                      </div>
                      <hr>
