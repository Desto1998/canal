                ...
                <div class="card-body">
                    ...
                    <form role="form" method="post" action="{{route('upgrade.client',$datas->id_client)}}">
                        ...
                        <div class="form-group">
                            Nom client<br><input class="form-control" placeholder="{{ $datas->nom_client }}"
                                                 name="nom_client" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            N° téléphone client<br><input class="form-control"
                                                          placeholder="{{ $datas->telephone_client }}"
                                                          name="telephone_client" disabled>
                        </div>
                        @foreach ($decodeur as $dec)
                            <div class="form-group">
                                N° decodeur<br><input class="form-control" placeholder="{{ $dec->num_decodeur }}"
                                                      name="num_decodeur" disabled>
                            </div>
                        @endforeach
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            Formule précedente :<br><input class="form-control"
                                                           placeholder="{{ $formule[0]->nom_formule }}"
                                                           name="adresse_client" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-center">
                            ...
                            <label class="ml-4"><input type="checkbox" value="1" name="sendsms">&nbsp; Envoyer un SMS au
                                client?</label>
                        </div>
                        <div class="form-group">
                            Date reabonnement<br><input class="form-control"
                                                        value="{{ $reabonnement[0]->date_reabonnement }}"
                                                        name="date_reabonnement" type="date" readonly required>
                        </div>
                        <hr>


                        <button type="submit" class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Upgrader
                        </button>
                    </form>
                </div>
            </div>
